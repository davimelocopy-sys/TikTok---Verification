# Diretrizes da Comunidade | Visão geral
...
O feed "Para Você" foi criado para ajudar na descoberta de diversos conteúdos e criadores, permitindo que alcencem novas audiências e formem comunidades vibrantes. No entanto, nem todo conteúdo é garantido no processo de recomendação. Quando identificamos conteúdo que se enquadra nos padrões de “Inelegível ao feed 'Para Você'\" nas Diretrizes da Comunidade, ele não será recomendado no feed "Para Você".

---

## Ferramentas e recursos
Oferecemos um kit de ferramentas de segurança que permite personalizar suas preferências de conteúdo e configurações da conta, além de gerenciar interações. Você também pode acessar os recursos da nossa Central de Segurança para receber mais suporte.
